...
$(document).on('click', '#tombolPopup', function (e) {
    ...
    Swal.fire({
        icon: 'info',
        title: 'Halo zaniut',
        text: 'abang ada pertanyaan nih buat niut',
        showClass: {
        ...
        Swal.fire({
            ...
            Swal.fire({
                ...
                Swal.fire({
                    title: 'Masukkin nama niut dulu dong',
                    showClass: {
                        popup: 'animate__animated animate__jackInTheBox'
                    },
                    hideClass: {
                    ...
                    function () {
                        ...
                        console.log(nama);
                        Swal.fire({
                            title: nama + ' ' + 'sayang gak sama abang?',
                            icon: 'question',
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    title: 'abang juga sayang banget sama ' + nama,
                                    showClass: {
                                        popup: 'animate__animated animate__jackInTheBox'
                                    },
                                    hideClass: {
                                    ...
                                    Swal.queue([{
                                        title: 'Seberapa sayang' + ' ' + nama + ' ' + 'ke abang?',
                                        confirmButtonText: 'Submit',
                                        showCancelButton: true,
                                        text: 'Coba isi pengen tau seberapa sayang niut ke abang',
                                        showClass: {
                                            popup: 'animate__animated animate__jackInTheBox'
                                        },
                                        hideClass: {
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: 'Terima kasih sudah sayang ke abang' + ' ' + value + '%',
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                        ...
                                        Swal.fire({
                                            title: 'Sekarang' + ' ' + nama + ' ' + 'kangen sama abang gak?',
                                            icon: 'question',
                                            type: 'question',
                                            showClass: {
                                                popup: 'animate__animated animate__jackInTheBox'
                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    title: 'Sama abang juga kangen sama' + ' ' + nama,
                                                    icon: 'info',
                                                    showClass: {
                                                        popup: 'animate__animated animate__jackInTheBox'
                                                    },
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        $.playSound('asset/audio/love.mp3');
                                                        confetti.start();
                                                    })
                                                })
                                            } else {
                                ...
                                Swal.fire({
                                    title: 'Beneran? abang tanya sekali lagi nih. Sayang gak sama abang?',
                                    icon: 'question',
